...
// Adapted from DISPLAY 17.3 in Savitch.
// 
// A program to demonstrate a generic version of selection sort.
#include <iostream>
#include "mysort.h"  // template functions for selection sort
